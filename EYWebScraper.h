 ...
 * If gist is fetched successfully, the target web page will be loaded into a dummy unvisible UIWebView, and JavaScript from the gist will be used for scaping when the page loads completely.
